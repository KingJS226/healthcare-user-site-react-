...
import { MDBRow, MDBCardBody, MDBCardHeader, ToastContainer, toast, MDBListGroup, MDBCard, MDBCol, MDBListGroupItem, MDBBtn, MDBContainer } from "mdbreact";
  ...
  componentDidMount() {
    ...
    save() {
        ...
        if (patientID !== this.props.location.anamnesis.patientId) {
            AnamnesisApi.update({patientId: patientID}, this.props.location.anamnesis.id).then((res) => {
                                        ...
                                        return <MDBListGroupItem key={index}>
                                            <MDBRow>
                                                <MDBCol lg="10" className="mb-10">
                                                    ...
                                                    {answer.responseType === 3&&<SelectAnswer value={answer.answer} onChangeAnswer={(answer) => this.changeAnswer(index, answer)}/>}
                                                ...
                                                <MDBCol lg="2" className="mb-2" >
                                                    ...
                                                    <Relevant value={answer.relevant} onChangeRelevant={(relevant) => this.changeRelevant(index, relevant)}/>
                                                </MDBCol>
                                            </MDBRow>
                                        </MDBListGroupItem>
                                    })}
