...
import { MDBListGroup, MDBRow, MDBCol, MDBDataTable, MDBListGroupItem, MDBCardBody, MDBCardHeader, MDBCard, MDBBtn, MDBContainer } from "mdbreact";
...
class AnamnesisView extends Component{
  ...
  componentDidMount() {
        ...
        const token1 = loadState('token');
        BaseApi.authToken=token1;
        console.log(loadState('doctorName'));
        this.getAnswers();
    }
