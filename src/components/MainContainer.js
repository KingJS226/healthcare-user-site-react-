...
import { MDBNavbar, MDBNavbarBrand, MDBNavbarNav, MDBNavbarToggler, MDBCollapse,   MDBNavItem, MDBFooter, MDBNavLink, MDBDropdown, MDBDropdownToggle, MDBDropdownMenu,  MDBDropdownItem, MDBIcon } from "mdbreact";
                        ...
                        <MDBNavItem>
                            <MDBDropdown>
                                ...
                                <MDBDropdownMenu className="dropdown-default" right>
                                    <MDBDropdownItem onClick={(event) => this.removeToken(event)}>{t('logout')}</MDBDropdownItem>
                                </MDBDropdownMenu>
                            </MDBDropdown>
                        </MDBNavItem>
                    </MDBNavbarNav>
